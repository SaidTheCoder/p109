...
print("mean,median,mode and standard deviation of the height is {},{},{} and {} respectivly".format( mean, median, mode, std_deviation))
...
fig.add_trace(go.Scatter(x=[first_std_deviation_start,first_std_deviation_start],y=[0,0.17],mode="lines",name="MEAN OF SAMPLE 2"))
